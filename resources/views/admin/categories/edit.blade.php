    ...
    <section class="relative bg-gradient-to-br from-emerald-600 via-emerald-500 to-teal-500 py-16 overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center text-white">
                ...
                <h1 class="text-3xl md:text-4xl font-bold mb-4">Edit Kategori</h1>
							...
							@if($category->image)
								<div class="mb-4 p-4 bg-gray-50 rounded-xl">
									<div class="flex items-center space-x-4">
										<img src="{{ Storage::url($category->image) }}" alt="Current category image" class="w-20 h-20 object-cover rounded-lg shadow-md">
										<div>
