<x-app-layout>
    <!-- Header Section -->
    <section class="relative bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 py-20 overflow-hidden">
        <!-- Animated Background -->
        <div class="absolute inset-0">
            ...
            <div class="absolute top-1/3 right-1/3 w-64 h-64 bg-yellow-300 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-blob animation-delay-2000"></div>
            <div class="absolute bottom-1/4 left-1/2 w-64 h-64 bg-pink-300 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-blob animation-delay-4000"></div>
        </div>
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                ...
                <h1 class="text-4xl md:text-6xl font-bold text-white mb-6">
                    Katalog <span class="bg-gradient-to-r from-yellow-400 via-pink-500 to-purple-600 bg-clip-text text-transparent">Furniture</span>
                </h1>
    ...
    <div class="py-8 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <!-- Search and Filter Section -->
                        <!-- Filter Section -->
            <div class="bg-white/70 backdrop-blur-lg rounded-2xl shadow-xl mb-8 p-8 border border-white/20">
                <h2 class="text-2xl font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent mb-8 flex items-center">
                ...
                <form method="get" class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                        ...
                        <div class="lg:col-span-2">
                            ...
                            <div class="relative group">
                                ...
                                <input type="text" 
                                       ...
                                       class="block w-full pl-12 pr-4 py-4 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 bg-white/90 text-gray-900 placeholder-gray-500 transition-all duration-300 hover:border-purple-300">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <select name="category_id" class="block w-full py-4 px-4 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 bg-white/90 text-gray-900 transition-all duration-300 hover:border-purple-300 appearance-none">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-200">
                        <button type="submit" 
                                class="flex-1 sm:flex-none group relative inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-bold rounded-xl hover:from-purple-700 hover:to-pink-700 transition-all duration-300 transform hover:scale-105 hover:shadow-xl">
                        ...
                        <div class="flex-1 flex flex-wrap gap-2 items-center">
                            @if(request('q'))
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-800">
                                    "{{ request('q') }}"
                                    <a href="{{ route('catalog.index', request()->except('q')) }}" class="ml-2 hover:text-purple-600">×</a>
                                </span>
                            @endif
                            @if(request('category_id'))
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-pink-100 text-pink-800">
                                    ...
                                    <a href="{{ route('catalog.index', request()->except('category_id')) }}" class="ml-2 hover:text-pink-600">×</a>
                                </span>
                            @endif
                        </div>
                    </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 mb-12">
                ...
                <div class="group relative bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 overflow-hidden border border-white/50">
                    <div class="relative overflow-hidden">
                        <!-- Product Image -->
                        <div class="aspect-square bg-gradient-to-br from-gray-50 to-gray-100 group-hover:from-purple-50 group-hover:to-pink-50 transition-all duration-500 relative overflow-hidden">
                            @if($p->thumbnail_path)
                            ...
                            @else
                                <div class="flex items-center justify-center h-full">
                                    <svg class="w-16 h-16 text-gray-300 group-hover:text-purple-400 transition-all duration-500 group-hover:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- Product Info -->
                    <div class="p-6">
                        <h3 class="font-bold text-lg text-gray-900 mb-3 group-hover:text-purple-600 transition-colors duration-300 line-clamp-2 leading-tight">
                            {{ $p->name }}
                        </h3>
